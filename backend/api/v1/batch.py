    ...
    try:
        ...
        for r in results:
            resume = Resume(
                ...
                semantic_alignment=r.get("semantic_alignment", r.get("explanation", "")),
                impact_analysis=r.get("impact_analysis", ""),
                critical_gaps=r.get("critical_gaps", r.get("gaps", [])),
                actionable_feedback=r.get("actionable_feedback", []),
